...
Entrevista de 8 preguntas + scaffold de archivos al final.
...
Leer `cabelma-intake.md`. Verificar qué secciones Q1-Q8 tienen contenido vs. `[Tu respuesta aquí]`.
...
## Paso 2 — La entrevista (8 preguntas, tope fijo)
...
```
2/8 — Pegá 1-2 cosas que hayas escrito vos en el trabajo recientemente.
...
```
3/8 — ¿Cuáles son tus 2-3 prioridades más importantes para los próximos 90 días?
...
```
4/8 — ¿Con qué sistemas y herramientas trabajás día a día?
...
```
5/8 — ¿Cómo te comunicás con las personas que usan lo que hacés?
...
```
6/8 — ¿Qué informes o entregables generás regularmente?
...
```
7/8 — ¿Cuál es la tarea que más tiempo te lleva cada semana y que más te gustaría simplificar?
...
```
8/8 — Última. ¿Hay algo de tu área o tu trabajo que sea importante que el AI conozca?
...
1. **Tope de 8 preguntas.** No agregar Q9 en conversación.
...
3. **Scaffold en una sola pasada.** Después de Q8, generar todos los archivos de una. Sin confirmación archivo por archivo.
...
- **Test frío:** clonar repo limpio, correr onboarding, completar 8 respuestas, verificar que se generan los 8 archivos, hacer la pregunta de cierre y confirmar que cita Q2 + Q3 + Q7 específicamente. Genérico = falla.
